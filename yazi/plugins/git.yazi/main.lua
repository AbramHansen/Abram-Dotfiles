...
local function setup(st, opts)
	...
	local styles = {
		...
		[CODES.staged] = t.staged and ui.Style(t.staged) or ui.Style():fg("green"),
		[CODES.deleted] = t.deleted and ui.Style(t.deleted) or ui.Style():fg("yellow"),
		[CODES.updated] = t.updated and ui.Style(t.updated) or ui.Style():fg("red"),
		[CODES.unmodified] = t.unmodified and ui.Style(t.unmodified) or ui.Style():fg("darkgray"),
	}
	local signs = {
		...
		[CODES.unmodified] = t.unmodified_sign or " ",
	}
...
local function fetch(_, job)
	...
	for _, path in ipairs(paths) do
		...
		changed[s] = changed[s] or CODES.unmodified
	end
